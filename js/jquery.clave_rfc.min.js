...
a.charAt(l))continue;else if(","===a.charAt(l))continue;else b=a.charAt(l);c+=b}return d.regla3(c)}};n.fn.clave_rfc=function(a){if(d[a])return d[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof a||!a)return d.init.apply(this,arguments);n.error("El m\u00e9todo "+a+" no existe en la presente implementaci\u00f3n.")}})(jQuery);
